            ...
            try {
              ...
              if (data.type === 'message' && data.chatJid && data.text) {
                ...
                if (
                  ...
                  const cardId = await deps.sendCard(
                    data.chatJid,
                    data.title,
                    data.content,
                  );
                  ...
                  logger.info(
                    { chatJid: data.chatJid, cardId, sourceGroup },
                    'IPC card sent',
                  );
                } else {
                  logger.warn(
                ...
                if (
                  ...
                  logger.info(
                    { chatJid: data.chatJid, cardId: data.cardId, sourceGroup },
                    'IPC card updated',
                  );
                } else {
                  logger.warn(
                    { chatJid: data.chatJid, sourceGroup },
                    'Unauthorized IPC update_card attempt blocked',
                  );
                }
              }
